...
public class CloseTabPaneUI extends BasicTabbedPaneUI {
	...
	private void addMnemonic(int index, int mnemonic) {
		...
		mnemonicInputMap.put(KeyStroke.getKeyStroke(mnemonic, ActionEvent.ALT_MASK),
				"setSelectedIndex");
	...
	protected Rectangle getTabBounds(int tabIndex, Rectangle dest) {
		if (rects.length>tabIndex) {
			...
			System.out.println("CloseTabPaneUI --> index > length");
			dest.x = 0;
			dest.y = 0;
	...
	boolean requestMyFocusForVisibleComponent() {
		...
		//As of 1.4, isFocusTraversable() replaced by isFocusable().
		if (visibleComponent.isFocusTraversable()) {
		/** @TODO 
		 * check if replacement is ok!!
		 */
		//if (visibleComponent.isFocusable()) {
			visibleComponent.requestFocus();
			return true;
		} else if (visibleComponent instanceof JComponent) {
			//As of 1.4, requestDefaultFocus() replaced by FocusTraversalPolicy.getDefaultComponent(Container).requestFocus()
			 ...
			 * check if replacement is ok!!
			 */
			//((JComponent) visibleComponent).getFocusTraversalPolicy().getDefaultComponent(tabPane).requestFocus();
			return true;
		}
		return false;
	}
	...
	private static class RightAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 1551970004767962507L;
	...
	private static class LeftAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -8682704546031707617L;
	...
	private static class UpAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 8235070626286028681L;
	...
	private static class DownAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -3708174094254920133L;
	...
	private static class NextAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -4021840214204902246L;
	...
	private static class PreviousAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 6349730162766085486L;
	...
	private static class PageUpAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 8355148327712234654L;
	...
	private static class PageDownAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 4238607116344245644L;
	...
	private static class RequestFocusAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 3531377907373076053L;
	...
	private static class RequestFocusForVisibleAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -1263807959122343439L;
	...
	private static class SetSelectedIndexAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 1243419510383559838L;
	...
	private static class ScrollTabsForwardAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -2317304232016089081L;
	...
	private static class ScrollTabsBackwardAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 2062554526615716400L;
			...
			if (selectedIndex < 0) {
				...
				if (selectedComponent != null) {
					if (selectedComponent != visibleComponent
						...
						//As of 1.4, SwingUtilities.findFocusOwner(visibleComponent) replaced by KeyboardFocusManager.getFocusOwner().
	...
	private class ScrollableTabViewport extends JViewport implements UIResource {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 8745676304263749484L;
	...
	private class ScrollableTabPanel extends JPanel implements UIResource {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 7008599658829587594L;
	...
	protected class ScrollableTabButton extends BasicArrowButton implements
		 ...
		 * 
		 */
		private static final long serialVersionUID = 3495066559657622607L;
